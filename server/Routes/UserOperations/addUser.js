...
router.post("/DodajUzytkownika", async (req, res) => {
    ...
    bcrypt.hash(Password, saltRounds, (err, hash) => {
        ...
        connection.query("INSERT INTO uzytkownicy (Imie, Nazwisko, Rola, Adres, Kod_Pocztowy, Telefon, Login, Haslo) VALUES(?,?,?,?,?,?,?,?)",
            [Name, Surname, Role, Adress, Zipcode, Phone, Login, hash],
            (err, result) => {
                if (err) {
                    console.error(err);
                    return;
